...
namespace razz
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        public void Move(Vector3 move, bool crouch, bool jump, bool climb, bool use, bool changed, bool clicked, bool pick, bool rifle, bool hit)
        {
            if (!_interactionStates) return;
            ...
            if (hit)
            {
                if (_playerAnimator.GetBool("Fight"))
                    _playerAnimator.SetBool("Fight", false);
                else
                    _playerAnimator.SetBool("Fight", true);
            }
        ...
        public void StartPick()
        {
            ...
            _playerAnimator.SetBool("Pick", true);
        }
        ...
        public void StopPick()
        {
            ...
            _playerAnimator.SetBool("Pick", false);
        }
