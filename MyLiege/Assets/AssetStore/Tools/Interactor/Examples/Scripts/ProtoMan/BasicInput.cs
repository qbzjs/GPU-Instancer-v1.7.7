...
namespace razz
{
    ...
    public class BasicInput : MonoBehaviour
    {
        ...
        private void UpdateMovement()
        {
            ...
            {
                _playerController.Move(Vector3.zero, false, false, false, false, changed, false, false, false, false);
            }
            else if (_playerController)
            {
                _playerController.Move(_move, crouch, _jump, climb, use, changed, click, pick, rifle, hit);
            }
