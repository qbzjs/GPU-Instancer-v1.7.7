...
namespace Bewildered.SmartLibrary
{
    ...
    public abstract class LibraryCollection : ScriptableObject, IEnumerable<LibraryItem>, IReadOnlyCollection<LibraryItem>
    {
        ...
        /// <summary>
        /// Called when the editor first opens and after all collections have been loaded from file.
        /// </summary>
        /// <remarks>Parent and subcollection relations may not be restored for some collections yet.</remarks>
